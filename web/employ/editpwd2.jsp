...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>My97DatePicker/WdatePicker.js" charset="utf-8"></script><%--时间的应用--%>
</head>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div id="myTabContent" class="tab-content">
                    <form action="employ/editpwd2.action" name="myform" method="post" class="form">
