        ...
        <table class="table">
            ...
            <c:forEach items="${articleList}" var="article">
                <tr align="center">
                    ...
                    <td class="center"><a href="article/getArticleById.action?id=${article.articleid}"><i class="fa fa-pencil"></i></a>
                        &nbsp;&nbsp;
                        <a href="article/deleteArticle.action?id=${article.articleid}" onclick="{if(confirm('确定要删除吗？')){return true;}return false;}">
