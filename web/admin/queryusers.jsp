        ...
        <table class="table">
            ...
            <c:forEach items="${usersList}" var="users">
                <tr align="center">
                    ...
                    <td class="center">
                        <a href="users/getUsersById.action?id=${users.usersid}"><i class="fa fa-pencil"></i></a>
                        &nbsp;&nbsp;
                        <a href="users/deleteUsers.action?id=${users.usersid}" onclick="{if(confirm('确定要删除吗？')){return true;}return false;}">
