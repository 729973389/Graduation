                ...
                <div id="myTabContent" class="tab-content">
                    <form action="goods/updateGoods.action" name="myform" method="post" onsubmit="return check()" class="form">
                        ...
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                <label>点击量</label>
                                <input type="text" name="hits" id="hits" value="${goods.hits}" />
                            </div>
                        </div>
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                <label>预约量</label>
                                <input type="text" name="sellnum" id="sellnum" value="${goods.sellnum}" />
                            </div>
                        </div>
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="addtime" id="addtime" value="${goods.addtime}" />
