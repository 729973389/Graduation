...
<div class="content">
    <div class="header">
        <h1 class="page-title">编辑新闻公告信息</h1>
    </div>
                    ...
                    <form action="article/updateArticle.action" name="myform" method="post" onsubmit="return check()" class="form">
                        ...
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                <label>标题</label> <input type="text" name="title" class="form-control" id="title" value="${article.title}" />
                            </div>
                        </div>
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="image" value="${article.image}" id="image" onclick="selimage();"
                                       readonly="readonly" />
                            </div>
                        </div>
                        <div class="tab-pane active in" id="home">
