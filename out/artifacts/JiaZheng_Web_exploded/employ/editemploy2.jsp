        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div id="myTabContent" class="tab-content">
                    <form action="employ/updateEmploy2.action" name="myform" method="post" onsubmit="return check()" class="form">
                        ...
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sex" id="sex">
                                    <option value="男" <c:if test="${employ.sex eq '男'}">selected="selected"</c:if>>男</option>
                                    <option value="女" <c:if test="${employ.sex eq '女'}">selected="selected"</c:if>>女</option>
                                </select>
                            </div>
                        </div>
                        <div class="tab-pane active in" id="home">
