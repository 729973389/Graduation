    ...
    <div class="navbar-collapse collapse" style="height: 1px;">
        <ul id="main-menu" class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown hidden-xs">
                <a href="<%=basePath%>admin/editpwdFrame.jsp" title="">
                    <span>修改密码</span>
                </a>
            </li>
            <li class="dropdown hidden-xs">
                <a href="<%=basePath%>admin/exit.action" onclick="{if(confirm('确定要退出吗?')){return true;}return false;}" title=""><%--return表示是否执行action，如果是true则退出，如果是false则取消退出--%>
                    <span>退出系统</span>
                </a>
            </li>
        </ul>
