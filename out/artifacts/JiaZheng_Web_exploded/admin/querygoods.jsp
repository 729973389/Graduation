        ...
        <table class="table">
            ...
            <c:forEach items="${goodsList}" var="goods">
                <tr align="center">
                    ...
                    <td class="center"><a href="goods/getGoodsById.action?id=${goods.goodsid}"><i class="fa fa-pencil"></i></a>
                        &nbsp;&nbsp;
                        <a href="goods/deleteGoods.action?id=${goods.goodsid}" onclick="{if(confirm('确定要删除吗？')){return true;}return false;}">
