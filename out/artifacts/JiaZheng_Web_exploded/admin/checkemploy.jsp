        ...
        <table class="table">
            ...
            <c:forEach items="${employList}" var="employ">
                <tr align="center">
                    ...
                    <td>
                        <a href="employ/passCheckEmploy.action?id=${employ.employid}" onclick="{if(confirm('确定审核通过吗？')){return true;}return false;}">
                           通过
                        </a>&nbsp;&nbsp;
                        &nbsp;&nbsp;
                        <a href="employ/deleteCheckEmploy.action?id=${employ.employid}" onclick="{if(confirm('确定审核不通过吗？')){return true;}return false;}">
